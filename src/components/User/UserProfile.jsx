...
export default function UserProfile() {
    ...
    useEffectOnce(() => {
        fetchUserDetail()
            .then(() => console.log('User detail fetched'))
    })
                            ...
                            <form onSubmit={handleSubmitProfile}>
                                <div className="mb-5">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input type="text" id="name" name="name" className="w-full pl-10 pr-3 py-3 bg-gray-700 bg-opacity-50 border border-gray-600 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200" placeholder="Enter your full name" value={name} onChange={(e) => setName(e.target.value)} required />
                                    </div>
                                </div>
                                <div className="mt-6">
